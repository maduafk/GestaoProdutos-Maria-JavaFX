...
public class HelloController implements Initializable {
    ...
    public void onBtInfo(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Application.class.getResource("CalculoIMC.fxml"));
        painel.setCenter(fxmlLoader.load());
    }

    public void onBtHisto(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Application.class.getResource("PainelHistorico.fxml"));
        painel.setCenter(fxmlLoader.load());
    }
